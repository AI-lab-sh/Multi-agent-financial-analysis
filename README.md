...
style C fill:#dae8fc,stroke:#6c8ebf,stroke-width:4px,font-size:36px
style D fill:#fff2cc,stroke:#d6b656,stroke-width:4px,font-size:36px
style E fill:#f8cecc,stroke:#b85450,stroke-width:4px,font-size:36px
style F fill:#ffe6cc,stroke:#d79b00,stroke-width:4px,font-size:36px
style G fill:#e2d5e7,stroke:#9673a6,stroke-width:4px,font-size:36px
style H fill:#ffcc99,stroke:#ff9900,stroke-width:4px,font-size:36px
style I fill:#c3d6a3,stroke:#3c7e2e,stroke-width:5px,font-size:36px
```
